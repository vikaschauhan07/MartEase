        ...
        <div class="py-2 pb-4 d-flex justify-content-between flex-wrap">
            <div class="d-flex">
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{route('admin.add-blog')}}" class="add_btn text-decoration-none">Add blog</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @if($blogs->count() > 0)
                            ...
                            <tr class="align-middle table_heading">
                                ...
                                <td>
                                    <label class="switch">
                                        <input type="checkbox" id="togBtn-{{$blog->id}}" @if($blog->status == 1) checked @endif onchange="changeStatus(event, {{$blog->id}},{{$blog->status}})" >
                                ...
                                <td>
                                    <div class="item_center">
                                        <a href="{{route('admin.view-blog',["blog_id" => encrypt($blog->id)])}}">
