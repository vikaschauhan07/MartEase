...
@section('page-title') <h3 class="mb-0 page_title"><a href="{{route('admin.get-trip-list')}}">Trips Management</a> > Edit Trip</h3> @endsection
@section('content')
        ...
        <div class="row">
            <div class="col-lg-6 marginTopInput">
                <div class="position-relative custom_select">
                    <input type="hidden" value="{{$trip->id}}" id="tripId">
                    ...
                    <div class="input-group mb-3">
                        <select class="form-select" id="fromCity">
                            ...
                            @foreach($cityArray as $key => $value)
                                <option value="{{$key}}" @if($trip->from_city == $value) selected @endif>{{$value}}</option>    
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="position-relative custom_select">
                    ...
                    <div class="input-group mb-3">
                        <select class="form-select" id="toCity">
                            <option value="0" selected>Select</option>
                            @foreach($cityArray as $key => $value)
                                <option value="{{$key}}" @if($trip->to_city == $value) selected @endif>{{$value}}</option>    
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="position-relative custom_select">
                    ...
                    <div class="input-group mb-3">
                        <select class="form-select" id="trailerNumber">
                            <option value="{{$trip->trailer_number}}" selected>{{$trip->trailer_number}}</option>
            ...
            <div class="col-lg-6 marginTopInput">
                <div class="position-relative">
                    ...
                    <input class="login_input paddingStartInput w-100" value="{{$trip->delivery_price}}" id="deliveryPrice" type="number" placeholder="Enter" required>
                </div>
            ...
            <div class="col-lg-6 marginTopInput">
                <div class="position-relative">
                    ...
                    <input class="login_input paddingStartInput w-100"  value="{{$trip->pickup_location}}" id="pickUpLocation" type="text" placeholder="Enter" required>
                </div>
            ...
            <div class="col-lg-6 marginTopInput">
                <div class="position-relative">
                    ...
                    <input class="login_input paddingStartInput w-100" value="{{$trip->dropoff_location}}" id="dropOffLocation" type="text" placeholder="Enter" required>
                </div>
            ...
            <div class="col-lg-6 marginTopInput">
                <div class="position-relative">
                    ...
                    <input class="login_input paddingStartInput w-100" value="{{$trip->pickup_date}}" id="pickUpDate" type="date" placeholder="Enter" required>
                </div>
                    ...
                    <div class="input-group mb-3">
                        <select class="form-select" id="pickUpWindow">
                            @foreach($time_slots_array as $key => $value)
                                <option value="{{$key}}" @if($trip->pickup_window == $key) selected @endif>{{$value}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="position-relative custom_select">
                    ...
                    <div class="input-group mb-3">
                        <select class="form-select" id="dropOffWindow">
                            @foreach($time_slots_array as $key => $value)
                                <option value="{{$key}}" @if($trip->dropoff_window == $key) selected @endif>{{$value}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="col-lg-6 marginTopInput">
                <div class="position-relative">
                    ...
                    <input class="login_input paddingStartInput w-100" value="{{$trip->distance}}" id="distance" type="number" placeholder="Enter" required>
                </div>
        ...
        <div class="row">
            <div class="col-lg-6 marginTopInput">
                <div class="position-relative">
                    ...
                    <input class="login_input paddingStartInput w-10" value="{{$trip->trailer_length}}" id="trailerLength" type="number" placeholder="Enter" required>
                    *
                    <input class="login_input paddingStartInput w-10" value="{{$trip->trailer_breadth}}" id="trailerBreadth" type="number" placeholder="Enter" required>
                    *
                    <input class="login_input paddingStartInput w-00" value="{{$trip->trailer_height}}" id="trailerHeight" type="number" placeholder="Enter" required>
                </div>
            ...
            <div class="col-lg-6 marginTopInput">
                <div class="position-relative">
                    ...
                    <input class="login_input paddingStartInput w-100" value="{{$trip->trailer_weight}}" id="trailerWeight" type="number" placeholder="Enter" required>
                </div>
