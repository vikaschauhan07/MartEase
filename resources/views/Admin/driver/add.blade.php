...
@section('page-title') <h3 class="mb-0 page_title"><a href="{{route('admin.get-driver-list')}}">Drivers Management</a> > Add Driver</h3> @endsection
@section('content')
        ...
        <div class="row" id="driverForm">
            <div class="profileSet">
                <figure class="inner mb-0">
                    <img id="previewImage" class="uploadProfile" src="{{ asset('Admin/images/dummy-profile.svg') }}" alt="Preview Image">
                    <img id="image-btn" class="cmeraSet" src="{{ asset('Admin/images/camera.svg') }}" alt="camera">
            ...
            <div class="col-lg-6 marginTopInput">
                <div class="position-relative">
                    ...
                    <input id="name" class="login_input paddingStartInput w-100" name="name" type="text" placeholder="Enter Name" required>
                </div>
            ...
            <div class="col-lg-6 marginTopInput">
                <div class="position-relative">
                    ...
                    <input class="login_input paddingStartInput w-100" id="email" type="email" placeholder="Enter Name" required>
                </div>
            ...
            <div class="col-lg-6 marginTopInput">
                <div class="position-relative">
                    ...
                    <input class="login_input paddingStartInput w-100" id="phone_number" type="text" placeholder="Enter Phone Number" required>
                </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="position-relative">
                    <label class="upload_image_box w-100" for="" id="driving_licence_front_input">
                        <img id="driving_licence_front_preview" class="mb-2" src="{{ asset('Admin/images/upload-img.svg') }}" alt="camera">
                        <span id="driving_licence_front_preview_span">Upload Image</span>
                    </label>
            ...
            <div class="col-lg-6 ">
                ...
                <label class="upload_image_box w-100" for="" id="driving_licence_back_input">
                    <img id="driving_licence_back_preview" class="mb-2" src="{{ asset('Admin/images/upload-img.svg') }}" alt="camera">
                    <span id="driving_licence_back_preview_span">Upload Image</span>
                </label>
            ...
            <div class="col-lg-6 marginTop25">
                ...
                <label class="upload_image_box w-100" for="" id="vehicle_registration_input">
                    <img id="vehicle_registration_preview" class="mb-2" src="{{ asset('Admin/images/upload-img.svg') }}" alt="camera">
                    <span id="vehicle_registration_preview_span">Upload Image</span>
                </label>
            ...
            <div class="col-lg-6 marginTop25">
                ...
                <label class="upload_image_box w-100" for="" id="vehicle_insurance_input">
                    <img id="vehicle_insurance_preview" class="mb-2" src="{{ asset('Admin/images/upload-img.svg') }}" alt="camera">
                    <span id="vehicle_insurance_preview_span">Upload Image</span>
                </label>
...
<script>
    function saveEditForm(event) {
        ...
        $.ajax({
            url: "{{ route('admin.add-driver-post') }}", 
            type: "POST",
            data: formData,
            processData: false, 
            contentType: false, 
